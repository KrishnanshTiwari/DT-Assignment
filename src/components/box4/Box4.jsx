...
import './box4.css'
function Box4() {
    const data = [ "The 4SA Method, How to bring a idea into process?",
  ...
  return (
    ...
    <>
    <Collapsible trigger="Introduction +" triggerWhenOpen='Introduction -' open='true'>
        <p className='outer'><ReadMore text={data[0]} maxLength={140} /></p>
    </Collapsible>
                        <Collapsible trigger="Thread A+" triggerWhenOpen='Thread A -' open='true'>
                            <div>
                                <p className='outer'><ReadMore text={data[1]} maxLength={140} /></p>
                                <div className='inner'>
                                <h3>Example 1</h3>
                                <p><ReadMore text={data[2]} maxLength={140} /></p>
                                </div>
                            </div>
                        </Collapsible>
                        <Collapsible trigger="Transition 1 +" triggerWhenOpen='Transition 1 -' open='true'>
                            <div>
                                <p className='outer'><ReadMore text={data[3]} maxLength={140} /></p>
                            </div>
                        </Collapsible>
                        <Collapsible trigger="Thread A+" triggerWhenOpen='Thread A -' open='true'>
                            <div>
                                <div className='inner'>
                                <h3>Example 1</h3>
                                <p><ReadMore text={data[4]} maxLength={140} /></p>
                                </div>
                                <div className='inner'>
                                <h3>Example 2</h3>
                                <p><ReadMore text={data[5]} maxLength={140} /></p>
                                </div>
                                <div className='inner'>
                                <h3>Example 3</h3>
                                <p><ReadMore text={data[6]} maxLength={140} /></p>
                                </div>
                                <div className='inner'>
                                <h3>Example 4</h3>
                                <p><ReadMore text={data[7]} maxLength={140} /></p>
                                </div>
                            </div>
                        </Collapsible>
                        <Collapsible trigger="Conclusion +" triggerWhenOpen='Conclusion A -' open='true'>
                            <div>
                                <p className='outer'><ReadMore text={data[8]} maxLength={140} /></p>
                            </div>
                        </Collapsible>
    </>
  )
